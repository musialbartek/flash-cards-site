...
<html lang="pl-Pl">
  <head>
    ...
    <script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'UA-158176323-1');</script>
    <meta charset="utf-8" />
    <title>Fiszunie - zestawy</title>
  ...
  <?php
    ...
    ?>
     ...
     <?php
        require_once('sections/kitsTiles.php');
     ?>
